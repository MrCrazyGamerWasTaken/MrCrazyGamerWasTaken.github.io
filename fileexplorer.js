...
function MaximizeFileExplorer() {
    if (fileExplorerIsMaximized == 0) {
        ...
        document.getElementById("third-file-explorer-nav-search-container").style.width = "53%";
        document.getElementById("third-file-explorer-nav-second-search-container").style.width = "37%";
        document.getElementById("file-explorer-input").style.width = "90%";
        ...
        document.getElementById("file-explorer-menu-close").style.width = "2.7vw";
        document.getElementById("left-file-explorer-nav").style.width = "50%";
        document.getElementById("third-file-explorer-nav-search-container").style.width = "49%";
        document.getElementById("third-file-explorer-nav-second-search-container").style.width = "31.5%";
        document.getElementById("file-explorer-input").style.width = "63.5%";
